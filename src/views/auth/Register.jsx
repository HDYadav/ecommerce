...
const Register = () => {
    ...
    return (
        <div className='min-w-screen min-h-screen bg-[#cdcae9] flex justify-center items-center'>
            <div className='w-[350px] bg-[#6f68d1] text-[#ffffff] p-4 rounded-md'>
                <h1 className='text-center text-2xl mb-4 font-bold'>Register Page</h1>
                <h2 className='text-xl mb-3 font-bold'>Welcome to Ecommerce</h2>
                <p className='text-sm mb-4'>Please register your account</p>
